...
Following below analysis there has been several outcomes, and thees are:
...
We can see, that Tornado is by far the most severe type of weather event, causing around 10 times more cases, than next in a row. 
